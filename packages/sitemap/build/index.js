          ...
          if (internal.ready) {
            ...
            for (const [indexFileName, routeRequests] of Object.entries(sitemapFileRequests)) {
              if (routeRequests.length > 0) {
                ...
                xml += SITEMAP_FOOTER;
                if (settings.distDir) {
                  import_fs_extra.default.writeFileSync(import_path.default.resolve(settings.distDir, `./${indexFileName}`), xml, {
                    encoding: "utf-8"
                  });
                }
            ...
            if (indexFiles.length > 0) {
              ...
              if (settings.distDir) {
                import_fs_extra.default.writeFileSync(import_path.default.resolve(settings.distDir, "./sitemap.xml"), indexXml, {
                  encoding: "utf-8"
                });
              }
            } else {
